...
import { HttpStrategy } from './auth_config/jwt.strategy';
import { GoogleStrategy } from './google_config/google.strategy';
import { JwtModule } from '@nestjs/jwt';
import { ConfigModule, ConfigService } from '@nestjs/config';
import googleOauthConfig from './google_config/google-oauth.config';
import { PassportModule } from '@nestjs/passport';
import { Forgot_Password_Entity } from './forgot-password.entity';
